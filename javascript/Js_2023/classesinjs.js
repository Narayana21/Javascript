...
function Construct(n,m,a){
    ...
    this.company=m
    this.age=a
    this.abc=function(){return `hello ${this.name}`}
}

let obj1=new Construct('abc','xyz',12)
console.log(obj1.abc())
let obj2=new Construct('abc','xyz',12)
console.log(obj1)
...
class programmer extends person{
    constructor(n,a,yearsOfExperience){
        super(n,a) // super is kewyword used to acces the elements of parent class
